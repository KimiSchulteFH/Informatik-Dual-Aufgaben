public class Baum<T extends Comparable<T>>
{
  ...
  private String traversierePreOrder(final Knoten<T> einKnoten) {
    ...
    if (einKnoten.getKnotenLinks() == null && einKnoten.getKnotenRechts() == null) {
      return einKnoten.getDaten() + "";
    } else if (einKnoten.getKnotenRechts() != null && einKnoten.getKnotenLinks() != null) {
    ...
    return einKnoten.getDaten() + " " + traversierePreOrder(einKnoten.getKnotenRechts());
  }
  ...
  private String traversiereInOrder(final Knoten<T> einKnoten)
  {
    if (einKnoten.getKnotenLinks() == null && einKnoten.getKnotenRechts() == null) {
      ...
      return  traversiereInOrder(einKnoten.getKnotenLinks()) + " " + einKnoten.getDaten();
    }
    return einKnoten.getDaten() + " " + traversiereInOrder(einKnoten.getKnotenRechts());
  }
  ...
  private String traversierePostOrder(final Knoten<T> einKnoten)
  {
    if (einKnoten.getKnotenLinks() == null && einKnoten.getKnotenRechts() == null) {
      ...
      return  traversierePostOrder(einKnoten.getKnotenLinks()) + " " + einKnoten.getDaten();
    }
    return traversierePostOrder(einKnoten.getKnotenRechts()) + " " + einKnoten.getDaten();
  }
  ...
  {
    if(einKnoten == null) {return 0;}
    if (einKnoten.getKnotenLinks() == null && einKnoten.getKnotenRechts() == null) {
      return 1;
    } else if (einKnoten.getKnotenRechts() != null && einKnoten.getKnotenLinks() != null) {
      if(hoeheRek(einKnoten.getKnotenLinks()) >= hoeheRek(einKnoten.getKnotenRechts())) {
        return hoeheRek(einKnoten.getKnotenLinks()) + 1;
      } else {return hoeheRek(einKnoten.getKnotenRechts()) + 1;}
    } else if(einKnoten.getKnotenLinks() != null && einKnoten.getKnotenRechts() == null) {
      return  hoeheRek(einKnoten.getKnotenLinks()) + 1;
    }
    return hoeheRek(einKnoten.getKnotenRechts()) + 1;
  }
